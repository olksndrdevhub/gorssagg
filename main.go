...
func main() {
	...
	v1Router.Get("/users/me", apiConfig.middlewareAuth(apiConfig.handlerGetUser))
	...
	v1Router.Get("/feed-follows", apiConfig.middlewareAuth(apiConfig.handlerGetFeedFollowsForUser))
